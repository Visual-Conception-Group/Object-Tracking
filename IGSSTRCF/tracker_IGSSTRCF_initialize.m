function [state, location, params] = tracker_IGSSTRCF_initialize(im, region, params)
...
params.admm_lambda1 = .8;%1.2;
params.admm_lambda2 = 0.8;%0.001; %0
...
params.alphaq = 1;
params.gamma = 0;
params.theta=0.00001;
params.ifcompress=1;
params.ifcompress1=1;
state.ifcompress=1;
params.w_init = 7;
% params.name = seq.VidName;
